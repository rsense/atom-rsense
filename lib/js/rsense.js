...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$native_accessor', '$alias_native']);
  return (function($base) {
    var self = $module($base, 'Atom');
    ...
    (function($base, $super) {
      ...
      self.$native_accessor("stdin", "stdout", "stderr", "argv", "execPath", "execArgv", "env", "version", "versions", "config", "pid", "title", "arch", "platform", (def.$initialize = TMP_1 = function() {
        var self = this, $iter = TMP_1._p, $yield = $iter || nil;

        TMP_1._p = null;
        return $opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [process]);
      }, nil) && 'initialize');

      self.$alias_native("cwd");

      return self.$alias_native("chdir");
    })(self, null)
    
  })(self)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/atom/process.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
...
(function($opal) {
  ...
  $opal.add_stubs(['$scopes_list', '$any?', '$match', '$Native', '$getCursorBufferPosition', '$scopesForBufferPosition', '$module_function']);
  ;
  return (function($base) {
    var self = $module($base, 'Rsense');
    ...
    (function($base) {
      ...
      def.$check_scope = function(editor) {
        var $a, $b, TMP_1, self = this, scopes = nil;

        scopes = self.$scopes_list(editor);
        return ($a = ($b = scopes)['$any?'], $a._p = (TMP_1 = function(scope){var self = TMP_1._s || this;
if (scope == null) scope = nil;
        return scope.$match(/source\.ruby/)}, TMP_1._s = self, TMP_1), $a).call($b);
      };

      def.$scopes_list = function(editor) {
        var self = this, point = nil;
        if (self.editor == null) self.editor = nil;

        self.editor = self.$Native(editor);
        point = self.$Native(self.editor.$getCursorBufferPosition());
        return self.editor.$scopesForBufferPosition(point);
      };
      ...
      self.$module_function("check_scope");

      self.$module_function("scopes_list");

      self.$module_function("editor");
            ;$opal.donate(self, ["$check_scope", "$scopes_list", "$editor"]);
    })(self)
    
  })(self);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/rsense/utils.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module, $klass = $opal.klass, $hash2 = $opal.hash2;

  $opal.add_stubs(['$attr_accessor', '$settings', '$config', '$port', '$rsense', '$getText', '$getPath', '$project', '$+', '$to_n', '$Native', '$getActiveEditor', '$workspace', '$check_scope', '$getCursor', '$getBufferRow', '$getBufferColumn', '$completions', '$uniq']);
  ;
  ;
  return (function($base) {
    var self = $module($base, 'Rsense');
    ...
    (function($base, $super) {
      ...
      def.atom = def.settings = def.editor = def.project_path = def.text = def.rsense_port = nil;
      Suggestion = require("autocomplete-plus").Suggestion;

      self.$attr_accessor("atom", "editor", "text", "tempfile", "file", "filepath", "candidates", "settings", "rsense_port", "view");

      def.$initialize = function(atom) {
        var self = this;

        self.atom = atom;
        self.settings = self.atom.$config().$settings();
        return self.rsense_port = self.settings.$rsense().$port();
      };

      def.$completions = function(editor, row, col) {
        var self = this, send_json = nil, ajaxhash = nil;

        self.editor = editor;
        self.candidates = [];
        self.text = self.editor.$getText();
        self.project_path = self.atom.$project().$getPath();
        send_json = JSON.stringify({
          command: "code_completion",
          project: self.project_path,
          file: self.editor.$getPath(),
          code: self.text,
          location: {
            row: row['$+'](1),
            column: col['$+'](1)
        ...
        ajaxhash = $hash2(["url", "type", "contentType", "dataType", "data"], {"url": "http://localhost:" + (self.rsense_port), "type": "POST", "contentType": "application/json; charset=utf-8", "dataType": "json", "data": send_json});
        return [send_json, ajaxhash.$to_n()];
      };

      def.$check_completion = function(view) {
        var $a, $b, $c, self = this, cursor = nil, row = nil, col = nil;

        self.view = self.$Native(view);
        self.editor = self.atom.$workspace().$getActiveEditor();
        if ((($a = (($b = ((($c = $scope.Rsense) == null ? $opal.cm('Rsense') : $c))._scope).Utils == null ? $b.cm('Utils') : $b.Utils).$check_scope(self.editor)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          return nil
        };
        ...
        return self.$completions(self.editor, row, col);
      };

      return (def.$cleanup = function(arr) {
        var self = this, n_arr = nil;

        n_arr = self.$Native(arr);
        return n_arr.$uniq();
      }, nil) && 'cleanup';
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/rsense/client.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module, $klass = $opal.klass;

  $opal.add_stubs(['$attr_accessor', '$new', '$settings', '$config', '$port', '$rsense', '$getPath', '$project', '$cwd', '$process_env_vars', '$stop_server', '$rsenseBinPath', '$lambda', '$chdir']);
  ;
  ;
  ;
  ;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $Server(){};
      var self = $Server = $klass($base, $super, 'Server', $Server);

      var def = self._proto, $scope = self._scope;

      def.atom = def.rsense_port = def.settings = def.project_path = def.process = def.start_path = nil;
      self.$attr_accessor("atom", "settings", "start_path", "process");
      ...
      def.$initialize = function() {
        ...
        self.settings = self.atom.$config().$settings();
        return self.process = (($a = ((($b = $scope.Atom) == null ? $opal.cm('Atom') : $b))._scope).Process == null ? $a.cm('Process') : $a.Process).$new();
      };

      def.$process_env_vars = function() {
        var $a, self = this;

        self.rsense_port = ((($a = self.rsense_port) !== false && $a !== nil) ? $a : self.settings.$rsense().$port());
        self.project_path = ((($a = self.project_path) !== false && $a !== nil) ? $a : self.atom.$project().$getPath());
        return self.start_path = self.process.$cwd();
      };

      def.$start_server = function() {
        var $a, $b, TMP_1, $c, TMP_2, $d, self = this, rsense_bin = nil, command = nil, args = nil, stdout = nil, myexit = nil, buffer = nil;

        self.$process_env_vars();
        self.$stop_server();
        rsense_bin = self.settings.$rsense().$rsenseBinPath();
        command = "" + (rsense_bin);
        args = ["start", "--port", self.rsense_port];
        stdout = ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(output){var self = TMP_1._s || this;
if (output == null) output = nil;
        return console.log(output);}, TMP_1._s = self, TMP_1), $a).call($b);
        myexit = ($a = ($c = self).$lambda, $a._p = (TMP_2 = function(code){var self = TMP_2._s || this;
          if (self.rsense_port == null) self.rsense_port = nil;
if (code == null) code = nil;
        return console.log("Rsense Started on port " + self.rsense_port);}, TMP_2._s = self, TMP_2), $a).call($c);
        self.process.$chdir(self.project_path);
        buffer = (($a = ((($d = $scope.Atom) == null ? $opal.cm('Atom') : $d))._scope).BufProcess == null ? $a.cm('BufProcess') : $a.BufProcess).$new(command, args, stdout, myexit);
        return self.process.$chdir(self.start_path);
      };

      return (def.$stop_server = function() {
        var $a, $b, TMP_3, $c, TMP_4, $d, self = this, rsense_bin = nil, command = nil, args = nil, stdout = nil, myexit = nil, buffer = nil;

        rsense_bin = self.settings.$rsense().$rsenseBinPath();
        command = "" + (rsense_bin);
        args = ["stop"];
        stdout = ($a = ($b = self).$lambda, $a._p = (TMP_3 = function(output){var self = TMP_3._s || this;
if (output == null) output = nil;
        console.log("Rsense Server Stopped");
          return console.log(output);}, TMP_3._s = self, TMP_3), $a).call($b);
        myexit = ($a = ($c = self).$lambda, $a._p = (TMP_4 = function(code){var self = TMP_4._s || this;
if (code == null) code = nil;
        return nil}, TMP_4._s = self, TMP_4), $a).call($c);
        self.process.$chdir(self.project_path);
        buffer = (($a = ((($d = $scope.Atom) == null ? $opal.cm('Atom') : $d))._scope).BufProcess == null ? $a.cm('BufProcess') : $a.BufProcess).$new(command, args, stdout, myexit);
        return self.process.$chdir(self.start_path);
      }, nil) && 'stop_server';
...
//# sourceMappingURL=/__opal_source_maps__/rsense/server.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module, $klass = $opal.klass;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $Rsense(){};
      var self = $Rsense = $klass($base, $super, 'Rsense', $Rsense);

      var def = self._proto, $scope = self._scope, $a;

      def.atom = def.providers = def.rsense_client = nil;
      self.$include((($a = $scope.Native) == null ? $opal.cm('Native') : $a));

      self.$attr_accessor("atom", "editor_subscription", "providers", "autocomplete", "rsense_client", "providers");

      def.$initialize = function() {
        var $a, $b, self = this;

        self.atom = (($a = ((($b = $scope.Atom) == null ? $opal.cm('Atom') : $b))._scope).Atom == null ? $a.cm('Atom') : $a.Atom).$new();
        self.rsense_client = (($a = ((($b = $scope.Rsense) == null ? $opal.cm('Rsense') : $b))._scope).Client == null ? $a.cm('Client') : $a.Client).$new(self.atom);
      ...
      def.$add_provider = function(provider) {
        ...
        return nprovider.$init(self.rsense_client);
      };
...
//# sourceMappingURL=/__opal_source_maps__/rsense.js.map
;
