...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$settings', '$config', '$port', '$rsense', '$getText', '$getPath', '$project', '$+', '$to_n', '$Native', '$getActiveEditor', '$workspace', '$getCursor', '$getBufferRow', '$getBufferColumn', '$completions', '$lambda', '$call']);
  ;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.atom = def.settings = def.editor = def.project_path = def.text = def.rsense_port = def.view = nil;
      ...
      def.$completions = function(editor, row, col, cb) {
        ...
        return self.view.ajax(ajaxhash.$to_n()).done(function(data) { cb(data) }).fail(function(err) { });
      };

      return (def.$check_completion = function(view, cb) {
        var $a, $b, TMP_1, self = this, cursor = nil, row = nil, col = nil;
        ...
        return self.$completions(self.editor, row, col, ($a = ($b = self).$lambda, $a._p = (TMP_1 = function(suggestions){var self = TMP_1._s || this;
if (suggestions == null) suggestions = nil;
        return cb.$call(null, suggestions)}, TMP_1._s = self, TMP_1), $a).call($b));
      }, nil) && 'check_completion';
    })(self, null)
...
if (code == null) code = nil;
        console.log("Rsense Started on port " + self.rsense_port);
          if (code['$=='](0)) {
            return nil
            } else {
