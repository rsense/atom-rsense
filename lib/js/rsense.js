...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$settings', '$config', '$port', '$rsense', '$getText', '$getPath', '$project', '$+', '$to_n', '$Native', '$getActiveEditor', '$workspace', '$getCursor', '$getBufferRow', '$getBufferColumn', '$completions']);
  ;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (def.$check_completion = function(view) {
        var self = this, cursor = nil, row = nil, col = nil;
